...
class InputMessage extends React.Component {
	...
	render() {
		...
		let sendButtonIcon = <i class="fa-solid fa-paper-plane-top"></i>;
		return (
...
class ChatRoom extends React.Component {
	...
	render() {
		...
		users[0] = { name: 'Amelia', avatar: 'https://i.pravatar.cc/150?img=32' };
		users[1] = { name: 'Michael', avatar: 'https://i.pravatar.cc/150?img=56' };
